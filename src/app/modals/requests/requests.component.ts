...
export class RequestComponent extends DialogComponent<PromptModel, any> implements PromptModel {
  ...
  currentRequest: any;
  user: User;
  constructor(public dialogService: DialogService, private userService: UserService, private requestsService: RequestsService, private authenticationService: AuthenticationService) {
    super(dialogService);
